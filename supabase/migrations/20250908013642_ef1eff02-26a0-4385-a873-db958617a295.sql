-- Clear existing variant data and add sample smartphone products
-- with proper variant structure matching NewVariantsList.tsx
UPDATE products SET color_variants = '[]'::jsonb, storage_variants = '[]'::jsonb;

-- Add sample smartphone product with proper variant structure
INSERT INTO products (id, name, description, price, color_variants, specifications, tags) VALUES
(
  gen_random_uuid(),
  'iPhone 15 Pro',
